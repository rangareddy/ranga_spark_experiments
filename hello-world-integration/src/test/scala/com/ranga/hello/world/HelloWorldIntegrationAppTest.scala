...
import HelloWorldIntegrationApp.{getEmployeeCount, getEmployeeDS}
...
class HelloWorldIntegrationAppTest extends FunSuite with BeforeAndAfterAll {

    @transient var spark: SparkSession = _

    override def beforeAll(): Unit = {
        val appName = "Hello World IntegrationTest"
