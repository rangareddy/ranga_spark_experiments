name := "spark-gcs-integration"
organization := "com.ranga.spark.gcs"
...
val gcs_connectorVersion = "2.1.2.7.1.6.0-297"
val gcs_connectorScope = "compile"
val testScope = "test"
...
lazy val appDependencies = Seq(
	...
	"com.google.cloud.bigdataoss" % s"gcs-connector" % gcs_connectorVersion % gcs_connectorScope
)
