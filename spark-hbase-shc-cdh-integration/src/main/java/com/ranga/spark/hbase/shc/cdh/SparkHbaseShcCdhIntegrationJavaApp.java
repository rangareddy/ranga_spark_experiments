package com.ranga.spark.hbase.shc.cdh;
...
public class SparkHbaseShcCdhIntegrationJavaApp implements Serializable {
    public static void main(String[] args) {

        String appName = "SparkHbaseShcCdhIntegrationApp Example";
