...
public class SparkGCSIntegrationJavaExample {
    ...
    public static void main(String[] args) {
        ...
        if(args.length < 3) {
            System.err.println("Usage   : SparkGCSIntegrationJavaExample <AWS_ACCESS_KEY_ID> <AWS_SECRET_ACCESS_KEY> <BUCKET_NAME>");
            System.out.println("Example : SparkGCSIntegrationJavaExample ranga_aws_access_key ranga_aws_secret_access_key ranga-spark-s3-bkt");
            System.exit(0);
        }
