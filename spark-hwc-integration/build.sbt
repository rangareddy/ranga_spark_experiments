name := "spark-hwc-integration"
organization := "com.ranga.spark.hwc"
...
val hwcVersion = "1.0.0.7.1.6.0-297"
val hwcScope = "compile"
val testScope = "test"
...
lazy val appDependencies = Seq(
	...
	"com.hortonworks.hive" % s"hive-warehouse-connector_${scalaBinaryVersion}" % hwcVersion % hwcScope
)
