...
public class SparkHelloWorldIntegrationJavaApp implements Serializable {

    private static final Logger logger = Logger.getLogger(SparkHelloWorldIntegrationJavaApp.class.getName());
