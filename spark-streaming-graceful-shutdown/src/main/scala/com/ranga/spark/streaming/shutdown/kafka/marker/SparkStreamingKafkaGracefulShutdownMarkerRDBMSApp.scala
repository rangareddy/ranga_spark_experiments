...
import com.ranga.spark.streaming.shutdown.util.jdbc.StopByMarkerRDBMS
...
object SparkStreamingKafkaGracefulShutdownMarkerRDBMSApp extends App with Serializable {
  ...
  private val Array(bootstrapServers, groupId, topic, driver, url, username, password) = args
  ...
  private val stopByMarkerRDBMS = new StopByMarkerRDBMS(driver, url, username, password)
  stopByMarkerRDBMS.updateMarkerRecordByStatus(appName, "RUNNING")
  ...
  stopByMarkerRDBMS.stopByMarkerRDBMS(streamingContext, appName)
